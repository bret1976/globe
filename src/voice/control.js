...
export function createVoiceControl({ reset = false } = {}) {
  ...
  if (!root) {
    ...
    root.innerHTML = `
      ...
      <button id="gev-voice-button" type="button" aria-label="Voice control — click and speak, or hold to talk" aria-describedby="gev-voice-help">
        <span class="gev-mic-orbit"><img src="/mic.svg" alt="" /></span>
        <span class="gev-mic-label">TALK</span>
      </button>
